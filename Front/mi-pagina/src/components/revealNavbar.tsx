...
import '@/styles/revealNavbar.css'
...
export default function RevealNavbar() {
    ...
    function handleScroll() {
        ...
        if (window.scrollY > 10 && navbar !== null) {
            navbar.classList.add('visible-nav')
        } else if (window.scrollY < 10 && navbar !== null) {
            navbar.classList.remove('visible-nav')
        }
    }

    return (
        <nav className='shadow-lg bg-gradient-to-t from-gray-900 to-gray-600 sticky top-0 z-10' id="second-nav">
